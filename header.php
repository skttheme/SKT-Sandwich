...
<?php esc_html_e( 'Skip to content', 'skt-sandwich' ); ?>
</a>
<?php
	...
	$hideheaderbutton = esc_html(get_theme_mod('hide_header_phonenumber', 1));	
?>
<div class="header <?php if( !is_home() && is_front_page() && $header_trans == '') {echo esc_html('transheader');}else{if(!is_home() && $header_trans_inner == '') {echo esc_html('transheader');}}?>">
  <div class="container">
    <div class="logo">
		<?php skt_sandwich_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
		...
		<?php wp_nav_menu( array('theme_location' => 'primary', 'container' => 'ul', 'menu_id' => 'primary', 'menu_class' => 'primary-menu menu' ) ); ?>
            ...
            <div class="header-phone-number">
                <?php if (!empty($header_phonenumbertext)) { ?>
                	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/header-button-img.png">
                    <span><?php esc_html_e('Call','skt-sandwich');?></span>
